...
INSERT INTO `Feedback` (`ID`, `studentID`, `professorID`, `dateTime`, `comment`) VALUES
...
(1, 1, 2147483647, 2147483644),
(11, 11, 2147483647, 2147483647),
(12, 12, 2147483647, 2147483647),
(13, 13, 2147483647, 2147483647),
...
(5, 13),
(6, 14);
INSERT INTO `Users` (`ID`, `email`, `password`, `firstName`, `lastName`, `type`) VALUES
(1, 'pawlicki@cs.rochester.edu', '$2y$10$lRWCMEejbmjj02hIwfMjvuATC2q2yC7eiH6uySm1RYciA0JxuyTQS', 'Ted', 'Pawlicki', 1),
(2, 'orojas@u.rochester.edu', '$2y$10$zbMUGaKAGfmvxWlt8HIsa.GzYTAC/khAy846xHsPSCecfaaNzkZ2K', 'Oscar', 'Rojas', 0),
(3, 'jan2@u.rochester.edu', '$2y$10$.VAc/y1rCFGbX3zTBJycpe9FP6EUj.bshNtBmBztx4EHDEtoUuz0G', 'Jinze', 'An', 0),
(4, 'student1@u.rochester.edu', '$2y$10$3H.hdVdHGY2BiyrqkijuzOjtr4SPw0W8wrj0hDZYLuwOl.6vkOGTq', 'Elena', 'Walker', 0),
(5, 'student2@u.rochester.edu', '$2y$10$3HUHQmAsgaIZ43BLZalI1unUhiLLKcKvwehZkpRi5GAkmm99uUhtO', 'Karel', 'Aristides', 0),
(6, 'student3@u.rochester.edu', '$2y$10$M08w4WXTfECX8wkeuCIvnuYKsbHOUtmQwmDhs.tL43CUWAWfDzb1e', 'Enlil', 'Amayas', 0),
(7, 'student4@u.rochester.edu', '$2y$10$JzcmmCVDtHIDVpDw/g7JuOqAx128LSwDJYS5dsKZx5HucDl6Fgndq', 'Eli', 'Edmund', 0),
(8, 'student5@u.rochester.edu', '$2y$10$b.KOpfmt5iRo4ix5/sMm1.hJ/WWmmgk7CYMKjEhnq2OMDGiBTKK1m', 'Thelonius', 'Afif', 0),
(9, 'student6@u.rochester.edu', '$2y$10$Xlrni1bV2MxbUb2mwfWbPujxB3/c6mXeAgrrrf2vvwlupIRy/DJz6', 'Stig', 'Euaristos', 0),
(10, 'student7@u.rochester.edu', '$2y$10$Ca/fSp85GnQqxZ3x.5alVOdLJFoN.R8MaiIcKyW1OmytF6ow.PLhO', 'Chidubern', 'Juho', 0),
(11, 'brown@cs.rochester.edu', '$2y$10$5h0ojOKkjACK9nCwiRp2/eW2obUaFGF5IviluR/x3f.wia0w9s9iK', 'Christopher', 'Brown', 1),
(12, 'martin@cs.rochester.edu', '$2y$10$OgCgpj81LO5tP4RDTM5g9ONfBGu8EK9dcowOx4dgTehN.HNfKShCe', 'Nathaniel', 'Martin', 1),
(13, 'lane@cs.rochester.edu', '$2y$10$db.fWC.VtOiYlVOe.OVVrOjUL1bpxVH9RzROE2trkqAaGCrZJNfme', 'Lane', 'Hemaspaandra', 1),
(14, 'scott@cs.rochester.edu', '$2y$10$w1ZOnPXxdDtUUmxuDWewt.WSnkDOJqeLwLzlexzm0oGQFRwwVYcLO', 'Michael', 'Scott', 1),
(15, 'marty@cs.rochester.edu', '$2y$10$mracYEf6CHNZjOzCANSP0ehFI1pIo.o2CQAqmtHxgmMpuLlvrAZqK', 'Marty', 'Guenther', 2);
