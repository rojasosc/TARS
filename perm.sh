...
# primary app perms
chmod $v_file *
chmod $v_dir . common css fonts images js plugins plugins/password_compat professor staff student
chmod $v_file common/* css/* fonts/* images/* js/* professor/* staff/* student/* plugins/password_compat/*
# git version perms
chmod $v_file .git/*
